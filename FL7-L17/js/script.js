...
var arr = ['Students', 'E-mail', 'Profile Picture', 'Skills', 'Controls'];
...
for (var i = 0; i < students.length; i++) {
    ...
    for (var prop in students[i]) {
        ...
        var text = document.createTextNode(students[i][prop]);
        
        if(prop == 'img') {
            var img = document.createElement('img');
            img.setAttribute('src', students[i][prop]);
            td.appendChild(img);
        ...
        if(prop == 'controls') {
        	...
        	text1.setAttribute('class', 'glyphicon glyphicon-edit')
        	text2.setAttribute('class', 'glyphicon glyphicon-trash')

        	ctrl1.setAttribute('class', 'btn btn-small btn-primary');
        	ctrl1.setAttribute('id', 'edit');
        	ctrl2.setAttribute('class', 'btn btn-small btn-danger');
        	ctrl2.setAttribute('id', 'remove');
        	
        	ctrl1.appendChild(text1);
        	ctrl2.appendChild(text2);
        	td.appendChild(ctrl1);
        	td.appendChild(ctrl2);
        }
        td.appendChild(text);
        tr.appendChild(td);
